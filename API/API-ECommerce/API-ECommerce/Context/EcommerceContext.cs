...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Cliente__D59466425A5C52B5");
        ...
        {
            entity.HasKey(e => e.IdItemPedido).HasName("PK__ItemPedi__F77088BACFFE9E7B");
        ...
        {
            entity.HasKey(e => e.IdPagamento).HasName("PK__Pagament__D474651EC51D298F");
        ...
        {
            entity.HasKey(e => e.IdPedido).HasName("PK__Pedido__9D335DC3F7C5C76B");
        ...
        {
            entity.HasKey(e => e.IdProduto).HasName("PK__Produto__2E883C23626DBE85");
