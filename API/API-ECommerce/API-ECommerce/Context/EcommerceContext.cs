...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=NOTE10-S28\\SQLEXPRESS;Initial Catalog=ECommerce;User Id=sa;Password=Senai@134;TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cliente>(entity =>
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Cliente__D59466428139CC10");

            entity.ToTable("Cliente");

            entity.HasIndex(e => e.Email, "UQ__Cliente__A9D105344FE08BC0").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdItemPedido).HasName("PK__ItemPedi__F77088BA557F0F1D");
        ...
        {
            entity.HasKey(e => e.IdPagamento).HasName("PK__Pagament__D474651EC7AA19E9");
        ...
        {
            entity.HasKey(e => e.IdPedido).HasName("PK__Pedido__9D335DC3F7B14472");
        ...
        {
            entity.HasKey(e => e.IdProduto).HasName("PK__Produto__2E883C23C7573AEB");
